...
+ (NSString *)getPath:(NSString *)path component:(NSString *)dir {
    NSString *componentPath = [path stringByAppendingPathComponent:dir];
...
+ (NSString *)getDirectoryForSupport:(NSString *)dir {
    NSError *error = nil;
    NSString *path = [[self getApplicationSupportPath] stringByAppendingPathComponent:dir];
    if(![[NSFileManager defaultManager] createDirectoryAtPath:path withIntermediateDirectories:YES attributes:nil error:&error]) {
        NSLog(@"create dir error: %@",error.debugDescription);
    }
    return path;
...
+ (NSString *)getPathForSupport:(NSString *)filename {
    return [[self getApplicationSupportPath] stringByAppendingPathComponent:filename];
}

+ (NSString *)getPathForSupport:(NSString *)filename inDir:(NSString *)dir {
    return [[self getDirectoryForSupport:dir] stringByAppendingPathComponent:filename];
}
